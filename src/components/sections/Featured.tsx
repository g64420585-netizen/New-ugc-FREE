...
export function Featured() {
  const featuredItems = [items[0], items[4]];
              ...
              >
                ...
                <div className="w-full md:w-1/2 p-8 flex flex-col justify-center">
                  ...
                  <div className="mt-auto flex items-center justify-between">
                    ...
                    <button
                      data-testid={`button-featured-claim-${item.id}`}
                      onClick={() => setSelectedItem(item)}
                      className="w-12 h-12 rounded-full bg-primary/10 text-primary border border-primary/20 flex items-center justify-center group-hover:bg-primary group-hover:text-white group-hover:border-primary transition-all shadow-[0_0_0_rgba(222,21,54,0)] group-hover:shadow-[0_0_15px_rgba(222,21,54,0.4)]"
                    >
